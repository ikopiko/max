        ...
        <div class="col-7 mt-2 right-innery">
          ...
          /> -->
            ...
            <div class="row my-5 right-3" v-if="showIngredients && !isSticks">
                ...
                <div class="col w-a-b" style="padding-left: 0">
                    <div class="w-h-1 square" v-bind:class="[
                { active: halfPizzaAll },
                ...
                <div class="col size p-0">
                    <div class="settingCircle yellow size_active font-weight-bold" v-bind:class="{ size_static: smallHalf, active: activeSmall }" @click="addSize('s')">
                        <span>S</span>
                    </div>
                </div>
                <div class="col size p-0">
                    <div class="settingCircle yellow font-weight-bold" v-bind:class="{ active: activeMedium }" @click="addSize('m')">
                        <span>M</span>
                    </div>
                </div>
                <div class="col size p-0">
                    <div class="settingCircle yellow font-weight-bold" v-bind:class="{ active: activeXl }" @click="addSize('xl')">
                        <span>XL</span>
                    </div>
                </div>
                <div class="col cuts p-0">
                    <div class="settingCircle gray cut_static font-weight-bold" v-bind:class="{ cut_active: cutActive }" @click="cuts()">
                        <span>16 Cut</span>
                    </div>
                </div>

                <div class="col p-0 paddingClear">&nbsp;</div>
...
export default {
        ...
        return {
            ...
            deliveryFee: [{
                ...
                },
                {
                    id: 2,
                    fee: 4.5,
                    text: "4.5 GEL 10-15.9 Km"
                },
                {
                    id: 3,
                    fee: 6,
                    text: "6 GEL 16-19.9 Km"
                },
                {
                    id: 4,
                    fee: 7,
                    text: "7 GEL 20-27.9 Km"
                },
                {
                    id: 5,
                    fee: 10,
    ...
    mounted() {
        ...
        axios
            .request({
                method: "post",
                url: "http://188.169.16.186:8082/ronny/rest/web/index.php?r=v1/products/get-ingredients-price",
                headers: {
        ...
        axios
            .request({
                method: "get",
                url: "http://188.169.16.186:8082/ronny/rest/web/index.php?r=v1/products/get-order-id",
                headers: {
                    Authorization: "Bearer " + TOKEN,
                },
            })
    ...
    computed: {
        ...
        ingredientComponent() {
            if (this.wholePizzaPart === 1) {
                ...
                this.ingToppings = this.pizza.toppings.concat(
                    this.pizza.half1.toppings,
                    this.pizza.half2.toppings
                );
                this.ingHalfPizza = this.isHalfPizza;
                ...
                this.ingDefToppings = this.customPizza.half2.defaultToppings.concat(
                    this.customPizza.half1.defaultToppings
                );
                this.ingToppings = this.customPizza.half2.toppings.concat(
                    this.customPizza.half1.toppings,
                    this.customPizza.toppings
                );
                this.ingHalfPizza = this.isHalfPizza;
    ...
    methods: {
        ...
        print() {
            axios
                .request({
                    method: "post",
                    url: "http://localhost/print/index.php",
                })
                .then((response) => {
        ...
        checkUser(tel) {
            ...
            axios
                .request({
                    method: "post",
                    url: "https://188.169.16.186:8082/ronny/rest/web/index.php?r=v1/customers/get-customer",
                    headers: {
                        Authorization: "Bearer " + TOKEN,
                    },
                    data: bodyFormData,
        ...
        testAxios() {
            ...
            axios
                .request({
                    method: "post",
                    url: "http://188.169.16.186:8082/ronny/rest/web/index.php?r=v1/manager/get-new-orders",
                    headers: {
                        Authorization: "Bearer " + TOKEN,
                    },
                    data: bodyFormData,
        ...
        productSelect(product) {
            ...
            if (product.category_name == "Pizza") {
                ...
                if (this.isHalfPizza == "yes" && this.halfPizzaCounter == 1) {
                    ...
                    this.customPizza.price =
                        this.customPizza.price + product.priceBySizes.m / 2;
                ...
                this.order.items.forEach((i) => {
                    if (
                        parseInt(i.id) === parseInt(product.id) &&
        ...
        deleteDefaultTopping(topping) {
            ...
            if (this.wholePizza || this.wholePizzaPart == 3) {
                ...
                this.order.items[this.itemIndex].defaultToppings.forEach((t, index) => {
                        ...
                        if (t.name.slice(0, 3) === "No ") {
                            ...
                            if (this.order.items[this.itemIndex].is_special == 0) {
                                if (topping.id == 5) {
                                    this.order.items[
                                        this.itemIndex
                                    ].totalPrice = this.order.items[this.itemIndex].totalPrice;
                                } else {
                                    this.order.items[
                                        this.itemIndex
                                    ].totalPrice = this.order.items[this.itemIndex].totalPrice;
                ...
                if (this.halfPizzaPart == 1) {
                    this.order.items[this.itemIndex].half1.defaultToppings.forEach(
                        (t, index) => {
                            if (parseInt(t.id) === parseInt(topping.id)) {
                                if (t.name.slice(0, 3) === "No ") {
                                    this.changeToppingPrice(
                                        this.order.items[this.itemIndex].size
                                    );
                                    this.order.items[this.itemIndex].half1.defaultToppings[
                                        index
                                    ].isDeleted = false;
                                    ...
                                    if (this.order.items[this.itemIndex].half1.is_special == 0) {
                                        ...
                                        this.order.items[this.itemIndex].half1is_special == 1
                                    ) {
                                        if (topping.id == 5) {
                                            this.order.items[
                                                this.itemIndex
                                    ...
                                    if (this.order.items[this.itemIndex].half1.is_special == 0) {
                                        ...
                                        this.order.items[this.itemIndex].half1.is_special == 1
                                    ) {
                                        if (topping.id == 5) {
                                            this.order.items[
                                                this.itemIndex
                ...
                this.order.items[this.itemIndex].defaultToppings.forEach((t, index) => {
                    if (topping.name.slice(0, 3) === "No ") {
                        ...
                        console.log(
                            "Default Toppings Array: ",
                            this.sticks.defaultToppings
                        );
                    }
                });
            }
        ...
        addSize(size) {
            if (this.isHalfPizza == "yes") {
                ...
                if (size === "xl") {
                    ...
                    this.customPizza.totalPrice = this.order.items[
                        this.itemIndex
                    ].totalPrice;
                ...
                if (size === "xl") {
                    ...
                    this.order.items[this.itemIndex].price = this.order.items[
                        this.itemIndex
                    ].totalPrice;
                    this.activeSmall = false;
                    this.noAB = false;
                ...
                if (this.halfPizzaPart == 1) {
                    ...
                    if (!matched) {
                        ...
                        if (!matched) {
                            ...
                            this.customPizza.half1.toppings.push({
                                ...topping,
                                count: 1
                            });
                        }
            ...
            if (this.halfPizzaPart == 2) {
                ...
                if (!matched) {
                    ...
                    if (!matched) {
                        ...
                        this.customPizza.half2.toppings.push({
                            ...topping,
                            count: 1
                        });
                    }
            ...
            // end of half pizza part 2
                ...
                if (!matched) {
                    ...
                    if (!matched) {
                        ...
                        this.customPizza.toppings.push({
                            ...topping,
                            count: 1
                        });
                    }
                ...
                if (this.wholePizzaPart === 1) {
                            ...
                            if (parseInt(t.id) === topping.id) {
                                ...
                                if (t.name.slice(0, 3) === "No ") {
                                    if (topping.id == 5) {
                                        ...
                                        this.pizza.totalPrice =
                                            this.pizza.totalPrice + topping.price;
                                    }
                                    t.name = topping.name;
                                    // this.pizza.totalPrice = this.pizza.totalPrice + topping.price;
                                    t.isDeleted = false;
                    ...
                    if (!matched) {
                        ...
                        this.pizza.half1.toppings.forEach((t) => {
                            if (parseInt(t.id) === topping.id) {
                                ...
                                if (this.pizza.size == "s") {
                                    t.price = this.toppingPrice[topping.isPremium].s / 2;
                                    this.pizza.totalPrice =
                                        this.pizza.totalPrice + t.price * t.count;
                                } else if (this.pizza.size == "m") {
                                    t.price = this.toppingPrice[topping.isPremium].m / 2;
                                    this.pizza.totalPrice =
                                        this.pizza.totalPrice + t.price * t.count;
                        ...
                        if (!matched) {
                            ...
                            this.pizza.half1.toppings.push({
                                ...topping,
                                count: 1
                            });
                        }
                    ...
                    if (!matched) {
                        ...
                        if (!matched) {
                            ...
                            this.pizza.half2.toppings.push({
                                ...topping,
                                count: 1
                            });
                        }
                ...
                if (this.order.items[i].custom == "other") {
                    ...
                    if (this.order.items[i].custom === "yes") {
                        ...
                        for (k = 0; k < this.order.items[i].half1.toppings.length; k++) {
                            ...
                            //alert(toppingTotal);
                            this.order.items[i].totalPrice =
                                this.order.items[i].price +
                                toppingTotal -
                                this.order.items[i].defCount;
                        }
                        ...
                        if (
                            ...
                            this.order.items[i].totalPrice =
                                this.order.items[i].price - this.order.items[i].defCount;
                        }
                    } else {
                        let defCount = 0;
        ...
        calcCash(cash) {
            ...
            if (this.splitActive) {
                if (this.splitPart === 1) {
                    ...
                    this.cashInput =
                        parseFloat(this.split.split1.input) +
                        parseFloat(this.split.split2.input);
            ...
            if (this.splitActive) {
                ...
                if (index > 2) {
                    if (this.cashInput.indexOf(".") === -1) {
                        this.cashInput =
                            this.cashInput.substr(0, index - 2) +
                            "." +
                            this.cashInput.substr(index - 2, index);
                    } else {
                        foo = this.cashInput.split(".").join("");
                        this.cashInput =
                            foo.substr(0, index - 3) + "." + foo.substr(index - 3, index);
                    }
                }
            }
        },
        doneCash() {
            ...
            if (
                ...
                if (
                    ...
                    if (
                        !this.deliveryActiveVar &&
                        !this.walkinActiveVar &&
                        !this.takeoutActiveVar &&
                        !this.glovoActive &&
                        !this.woltActive
                    ) {
        ...
        paymentConfirm() {
            ...
            if (this.paymentType == "cash" || this.paymentType == "card") {
                ...
                axios
                    .request({
                        method: "post",
                        url: "http://188.169.16.186:8082/ronny/rest/web/index.php?r=v1/products/send-order",
                        headers: {
                            Authorization: "Bearer " + TOKEN,
                        },
                        data: {
        ...
        printOrder(orderID) {
            ...
            axios
                .request({
                    method: "post",
                    url: "http://188.169.16.186:8082/ronny/rest/web/index.php?r=v1/orders/print",
                    headers: {
                        Authorization: "Bearer " + TOKEN,
                    },
                    data: bodyFormData,
        ...
        ronnysDelivery(ND) {
            ...
            this.glovoActive = false;
            if (ND === "no") {
                if (this.order.deliveryFee === 1.5) this.activeFee_el = 0;
                else if (this.order.deliveryFee === 3) this.activeFee_el = 1;
                else if (this.order.deliveryFee === 4.5) this.activeFee_el = 2;
                else if (this.order.deliveryFee === 6) this.activeFee_el = 3;
                else if (this.order.deliveryFee === 7) this.activeFee_el = 4;
                else if (this.order.deliveryFee === 10) this.activeFee_el = 5;
                else if (this.order.deliveryFee === 13.5) this.activeFee_el = 6;
                // pass
            } else {
        ...
        addCustomer() {
            ...
            axios
                .request({
                    method: "post",
                    url: "http://188.169.16.186:8082/ronny/rest/web/index.php?r=v1/customers/create-customer",
                    headers: {
                        Authorization: "Bearer " + TOKEN,
                    },
                    data: bodyFormData,
