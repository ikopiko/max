  ...
  <div class="container" style="max-width: 100%; margin-right: 20px;">
    ...
    <div class="row">
      ...
      <div class="col-7 mt-2">
        ...
        <div class="col-12 right-2" v-if="calculatorModal">
          ...
          <div class="row my-1">
              ...
              <div class="col-1 feeClass" v-if="deliveryActiveVar" :class="{active: activeFee_el == 2 }" @click="activateFee(2)">4.5 GEL 10-15.9 Km</div>
              <div class="col-1 feeClass" v-if="deliveryActiveVar" :class="{active: activeFee_el == 3 }" @click="activateFee(3)">6 GEL 16-19.9 Km</div>
        ...
        <div class="row mt-1 right-2" v-if="showIngredients">
          ...
          <ingredients
            ...
            @onAddTopping="addTopping"
            @onSendSauce="addSauce"
            @onShowProductsClear="showProductsClear"
            @onShowProductsComponent="showProductsComponent"
            @onDeleteDefTopping="deleteDefaultTopping"
            @onDeleteTopping="deleteTopping"
          />
          ...
          />
          <ingredients
            v-if="wholePizzaPart == 3"
            :product="this.pizza"
            :sauce="curSauce"
            :defaultToppings="this.pizza.defaultToppings"
            :toppings="this.pizza.toppings.concat(this.pizza.half1.toppings, this.pizza.half2.toppings)"
            :mapping="toppingIdCountMap"
            @onAddTopping="addTopping"
            @onSendSauce="addSauce"
            @onShowProductsClear="showProductsClear"
          ...
          />
          <ingredients
           v-if="halfPizzaPart == 2"
            :product="this.customPizza.half2"
            :isHalfPizza="this.isHalfPizza"
            :sauce="curSauce"
            :halfPizzaPart="this.halfPizzaPart"
            :defaultToppings="this.customPizza.half2.defaultToppings"
            :toppings="this.customPizza.half2.toppings"
            :mapping="toppingIdCountMap"
            @onAddTopping="addTopping"
            @onSendSauce="addSauce"
            @onShowProductsClear="showProductsClear"
          ...
          <ingredients
            v-if="halfPizzaAll"
            :product="this.customPizza"
            :isHalfPizza="this.isHalfPizza"
            :sauce="curSauce"
            :halfPizzaPart="this.halfPizzaPart"
            :defaultToppings="this.customPizza.half2.defaultToppings.concat(this.customPizza.half1.defaultToppings)"
            :toppings="this.customPizza.half2.toppings.concat(this.customPizza.half1.toppings, this.customPizza.toppings)"
            :mapping="toppingIdCountMap"
            @onAddTopping="addTopping"
            @onSendSauce="addSauce"
            @onShowProductsClear="showProductsClear"
            ...
            @onDeleteDefTopping="deleteDefaultTopping"
            @onDeleteTopping="deleteTopping"
            @onDeleteCusMainTopping="deleteCusMainTopping"
            @onDeleteCusTopping="deleteCusTopping"
          /> 
          <sticksIngredients v-if="isSticks"
            :defaultToppings="this.sticks.defaultToppings"
            :isSticks ="this.isSticks"
            :toppings="this.sticks.toppings"
            :mapping="toppingIdCountMap"
            @onAddTopping="addTopping"
            @onSticksSize="sticksSize"
            @onShowProductsClear="showProductsClear"
            @onShowProductsComponent="showProductsComponent"
            @onDeleteDefTopping="deleteDefaultTopping"
            @onDeleteTopping="deleteTopping"
      ...
      <div class="row my-5 right-3" v-if="showIngredients && !isSticks">
          ...
          <div class="col-md-1 p-0">
            <div
              class="settingCircle yellow size_active font-weight-bold"
              v-bind:class="{size_static: smallHalf, active : activeSmall}"
              @click="addSize('s')"
            >
              <span>S</span>
            </div>
          ...
          <div class="col-md-1 p-0">
            <div
              class="settingCircle gray cut_static font-weight-bold"
              v-bind:class="{cut_active : cutActive}"
              @click="cuts();"
            >
              <span>16 Cut</span>
            </div>
          ...
          <div class="col-md-1 p-0 paddingClear">&nbsp;</div>
          <div class="col-md-2 p-0 paddingClear"> <div class="w-1 " @click="showProductsComponent()"><i class="fa fa-check fa-4x iconColor"></i></div> </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" @click="couponModal = false">Close</button>
        ...
        <div class="modal-mask">
          <div class="modal-wrapper">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" v-if="!customerChecked">Add New Customer</h5>
                  <h5 class="modal-title" v-if="customerChecked">Edit Customer</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button
                    type="button"
                    class="btn btn-primary"
                    @click="deliverCustomer(deliveryFeeVar)"
                  >Delivery Fee</button>
                </div>
              </div>
            </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button
                    type="button"
                    class="btn btn-secondary"
                    @click="deliveryActiveModal = false"
                  >Close</button>
                  <button
                    type="button"
                    class="btn btn-primary"
                    @click="deliveryModal = true, deliveryTypeModal = false, deliverType(deliveryTypeVar)"
                  >Deliver Type</button>
                </div>
              </div>
            </div>
